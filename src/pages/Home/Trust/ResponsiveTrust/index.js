          ...
          >
            <Stack direction="column" spacing="20px">
              ...
              <Flex
                ...
                fontWeight="700"
              >
                We are a team of professionals you can trust!
              </Flex>
              ...
              <Flex justifyContent="center">
                <Flex
                  ...
                  textAlign="center"
                >
                  Our company is made up of experienced specialists who know how to
                  tackle the most complex challenges in IT. We pride ourselves on our
                  reputation and approach to work, where every solution is crafted to
              ...
              <Stack spacing="10px" ml="10px">
                <Flex align="center">
                  <Flex
                    ...
                    mr="8px"
                  />
                  Have deep expertise in modern technologies.
                </Flex>
                <Flex align="center">
                  <Flex
                    w="8px"
                    ...
                    mr="8px"
                  />
                  Continuously refine their skills to offer only the best solutions.
                </Flex>
                <Flex align="center">
                  <Flex
                    w="8px"
                    ...
                    mr="8px"
                  />
                  Work with attention to detail, quality, and deadlines.
                </Flex>
                <Flex align="center">
                  <Flex
                    w="8px"
                    ...
                    mr="8px"
                  />
                  Put your business goals at the heart of everything we do.
                </Flex>
              </Stack>
      
              {/* Заключение */}
              <Flex justifyContent="center" textAlign="center" fontSize="16px" fontWeight="500" mt="20px">
                With us, you can be confident in the results. We don't just create
                solutions; we lay the foundation for your success, helping your
