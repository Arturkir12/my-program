      ...
      <Stack direction="row" spacing="200px">
        ...
        <Flex alignItems="center" position="relative">
          ...
          >
            ...
            We're here to help you unlock your business potential through innovative technology solutions. Whether you have questions, need support, or want to discuss your next big project, we're just a message away.
            </Flex>
            <Flex mt="30px">
                <Stack direction="column">
                    <Flex>
                        ...
                        >
                            Email: <Flex ml="5px" color="#27272a" textDecoration="underline">{Email}</Flex> 
                        </Flex>
                    </Flex>
                    <Flex>
                        ...
                        fontFamily="Roboto"
                        >
                            Phone Number: <Flex color="#27272a" ml="5px" textDecoration="underline">{PhoneNumber}</Flex> 
                        </Flex>
                    </Flex>
                    <Flex>
                        ...
                        fontFamily="Roboto"
                        >
                            Location: <Flex ml="5px" color="#27272a" textDecoration="underline">{Location}</Flex> 
                        </Flex>
                    </Flex>
                </Stack>
            </Flex>
